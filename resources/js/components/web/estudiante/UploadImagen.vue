    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-xs-12 contain">
                <div class="form-row">
                    <label class="col-md-4 col-xs-12 control-label"><b>Fotografía Digital (*.jpg)</b></label>

                    <div class="col-md-2 col-xs-12">
                        <div class="input-group mb-3">
                            <div class="custom-file">
                                <!-- <input type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01"> -->
                                <button type="button" class="btn btn-primary" @click="openModal()"><i class="fa fa-image"></i> Selecionar</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-xs-12">
                        <p class="text-info w-text-info">
                            <i class="fa fa-info-circle"></i> La fotografía debe ser tomada de frente y con <b>fondo blanco</b>, sin prendas en la cabeza, sin gafas oscuras o
                            cualquier otra prenda que impida o dificulte la identificación de la persona.
                        </p>
                    </div>
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Seleccione y recorte</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-xs-12">
                                <p><b>Realice el recorte de acuerdo al siguiente ejemplo.</b></p>

                                <img class="img-thumbnail rounded" src="/images/ejemplo-foto.jpg" width="150" />
                            </div>
                        </div>
                    </div>

                    <div class="modal-footer">
                        <button type="button" v-on:click="cerrar()" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
