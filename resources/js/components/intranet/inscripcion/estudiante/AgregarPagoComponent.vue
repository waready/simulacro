<template>
    <div class="card mb-2 shadow-sm rounded">
        <div class="card-header text-white text-center bg-success py-1"><b class="card-title mb-0">Agregar Pago</b></div>
                    ...
                    <form class="" action="" @submit.prevent="submit">
                        <div class="form-row">
                            <div class="alert alert-info text-justify" role="alert">
                                <small class=""
                                    ><i class="fa fa-info-circle"></i> Para agregar un pago debe transcurrir un día despues de haber pagado ó <b>realizar el pago con un día de anticipación</b></small
                                >
                            </div>
