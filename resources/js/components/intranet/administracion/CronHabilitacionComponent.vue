            ...
            <div class="col-sm-12">
                <div class="card">
                    <header class="card-header">
                        Sincronización de Habilitación de estudiantes aptos a la base de datos de DGA
...
export default {
    ...
    methods: {
        sincronizar: function() {
            axios.get("sincronizar-habilitacion/").then(response => {
                // console.log(response);
            });
            this.disabledButton = true;
        },
        control: function() {
            axios.get("control-habilitacion/").then(response => {
