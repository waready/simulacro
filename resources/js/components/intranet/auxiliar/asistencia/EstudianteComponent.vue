                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <template v-else>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-12">
                                                    <label for="observacion">Observación</label>
                                                    <p>{{ observacionRealizada }}</p>
                                                </div>
                                            </div>
                                            <div class="row justify-content-end">
                                                <div class="col-md-4 text-right" v-if="permissions.includes('descargar asistencia estudiante')">
                                    ...
                                    <template v-if="!revisar">
                                        <div class="card-footer text-muted">
                                            <div class="row">
                                                <button v-if="permissions.includes('guardar lista estudiante')" class="btn btn-success btn-lg col" @click="guardar">
                                                    Guardar Lista
                                                </button>
                                            </div>
                                        </div>
    ...
    methods: {
        ...
        guardar: function() {
            ...
            for (const prop in this.estado) {
                ...
                // eval('var estado_'+prop+'_'+ this.estado[prop])
                estado.push(prop + "-" + this.estado[prop]);
                // console.log(`obj.${prop} = ${obj[prop]}`);
            }
            console.log(estado);
            // var estados = this.estado;
            $(".loader").show();
            axios
                .post("/intranet/auxiliar/asistencia/estudiante", {
                    fecha: this.fecha,
                    grupo: this.grupo,
        ...
        getAsistenciaEstudiante: function() {
            var estados = [];
            axios
                .get("/intranet/get-asistencia-estudiante", {
                    params: {
                        grupo: this.grupo,
                        fecha: this.fecha
                    }
                ...
                .then(response => {
                    ...
                    this.observacionRealizada = response.data.observacion;
