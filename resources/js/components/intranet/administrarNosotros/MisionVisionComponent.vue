        ...
        <div class="card">
          ...
          <div class="card-body">
            <v-server-table
              ...
              :columns="columns"
              :options="options"
              url="/intranet/administrar-nosotros/misionvision/lista/data"
            >
              <div slot="nosotros_tipo_dato_id" slot-scope="props">
                <span v-if="props.row.nosotros_tipo_dato_id == '1'"
                  >Misión</span
                >
                <span v-if="props.row.nosotros_tipo_dato_id == '2'"
                  >Visión</span
                >
              </div>
...
export default {
  ...
  methods: {
    ...
    editar: function (id) {
      ...
      axios.get("misionvision/" + id + "/edit").then((response) => {
    ...
    desactivar: function (id) {
      this.id = id;
      axios
        .put("misionvision/desactivar/" + this.id)
        .then((response) => {
          $(".loader").hide();
    ...
    submit: function () {
      ...
      if (this.edit == 0) {
        ...
        // console.log("EDITAR");
        axios
          .put("misionvision/" + this.id, this.fields)
          .then((response) => {
            $(".loader").hide();
            if (response.data.status) {
              this.$refs.table.refresh();
