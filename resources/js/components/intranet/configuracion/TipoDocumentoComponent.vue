        ...
        <div class="card">
          ...
          <div class="card-body">
            <v-server-table
              ...
              :columns="columns"
              :options="options"
              url="/intranet/configuracion/tipo-documento/lista/data"
            >
...
export default {
  ...
  methods: {
    ...
    editar: function (id) {
      ...
      axios.get("tipo-documento/" + id + "/edit").then((response) => {
    ...
    submit: function () {
      ...
      if (this.edit == 0)
        axios
          .post("tipo-documento", this.fields)
          .then((response) => {
        ...
        axios
          .put("tipo-documento/" + this.id, this.fields)
          .then((response) => {
            if (response.data.status) {
              this.$refs.table.refresh();
              toastr.success(response.data.message);
