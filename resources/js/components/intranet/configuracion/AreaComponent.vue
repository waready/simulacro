            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <v-server-table ref="table" :columns="columns" :options="options" url="/intranet/configuracion/areas/lista/data">
...
export default {
    ...
    methods: {
        ...
        editar: function(id) {
            ...
            axios.get("areas/" + id + "/edit").then(response => {
