@extends('layouts.web')
@section('titulo', 'Inscripcion correcta | CepreUNA | simulacro')
@section('css')
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="float-left">
                                                        ...
                                                        @else
                                                        <h5>Ud. se ah INSCRITO al SIMULACRO CEPREUNA de forma satisfactoria, descargue su formato PDF.</h5>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-xs-12">
                                                    ...
                                                    @else -->
                                                        <a class="btn btn-success mb-3" href="{{ url('inscripciones/simulacro/pdf/'.$id) }}" download="" >Descargar Ficha de Inscripción</a>

                                                        <div class="form-row">
                                                            <div class="col-md-12 text-center col-xs-12 embed-responsive embed-responsive-16by9">
                                                                <object class="embed-responsive-item" type="application/pdf" data="{{ url('inscripciones/simulacro/pdf/'.$id) }}" allowfullscreen></object>
                                                            </div>
                                                        </div>
