...
<body class="c-app">
    <div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
        <div class="c-sidebar-brand d-lg-down-none">
            <h4 class="text-info">ESTUDIANTE</h4>
        </div>
        <ul class="c-sidebar-nav">
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ url('estudiante/dashboard') }}">
            ...
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ url('estudiante/perfil') }}">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="{{ asset('coreui/vendors/@coreui/icons/svg/free.svg#cil-user') }}"></use>
                    </svg> Perfil</a>
            </li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ url('estudiante/horario') }}">
                    <svg class="c-sidebar-nav-icon">
            ...
            <li class="c-sidebar-nav-item c-sidebar-nav-dropdown"><a
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link"
                            href="{{ url('estudiante/cursos') }}"><span class="c-sidebar-nav-icon"></span> Mis
                            Cursos</a></li>
                    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link"
                            href="{{ url('estudiante/cursos/cuadernillo') }}"><span
                                class="c-sidebar-nav-icon"></span> Cuadernillos</a></li>
                </ul>
            </li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ url('estudiante/asistencia') }}">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="{{ asset('coreui/vendors/@coreui/icons/svg/free.svg#cil-calendar') }}">
                        </use>
                    </svg> Asistencia</a>
            </li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ url('estudiante/pago') }}">
                    <svg class="c-sidebar-nav-icon">
		  ...
		  <li class="c-header-nav-item px-3"><a class="c-header-nav-link">Settings</a></li>
            ...
            <ul class="c-header-nav ml-auto mr-4">
                ...
                <li class="c-header-nav-item dropdown"><a class="c-header-nav-link" data-toggle="dropdown" role="button"
                        ...
                        <div class="c-avatar">{{ Auth::user()->nombres }}</div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right pt-0">
                        <div class="dropdown-header bg-light py-2"><strong>Account</strong></div><a
                            class="dropdown-item" href="{{ url('estudiante/perfil') }}">
    ...
    <script src="{{ asset('js/app.js?v=1.21082516') }}"></script>
